"""Backward-compatibility shim for :mod:`praisonai.cli.commands.tools`.

The implementation moved to :mod:`praisonai_code.cli.commands.tools` as part
...
* ``from praisonai.cli.commands.tools import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.tools.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import tools as _impl
