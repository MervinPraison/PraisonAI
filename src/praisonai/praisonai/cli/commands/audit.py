"""Backward-compatibility shim for :mod:`praisonai.cli.commands.audit`.

The implementation moved to :mod:`praisonai_code.cli.commands.audit` as part
...
* ``from praisonai.cli.commands.audit import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.audit.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import audit as _impl
