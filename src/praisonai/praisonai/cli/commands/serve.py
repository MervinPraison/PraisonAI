"""Backward-compatibility shim for :mod:`praisonai.cli.commands.serve`.

The implementation moved to :mod:`praisonai_code.cli.commands.serve` as part
...
* ``from praisonai.cli.commands.serve import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.serve.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import serve as _impl
