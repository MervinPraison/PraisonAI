"""Backward-compatibility shim for :mod:`praisonai.cli.commands.up`.

The implementation moved to :mod:`praisonai_code.cli.commands.up` as part
...
* ``from praisonai.cli.commands.up import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.up.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import up as _impl
