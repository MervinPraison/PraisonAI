"""Backward-compatibility shim for :mod:`praisonai.cli.commands.daemon`.

The implementation moved to :mod:`praisonai_code.cli.commands.daemon` as part
...
* ``from praisonai.cli.commands.daemon import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.daemon.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import daemon as _impl
