"""Backward-compatibility shim for :mod:`praisonai.cli.commands.memory`.

The implementation moved to :mod:`praisonai_code.cli.commands.memory` as part
...
* ``from praisonai.cli.commands.memory import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.memory.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import memory as _impl
