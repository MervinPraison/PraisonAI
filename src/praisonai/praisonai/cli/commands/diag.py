"""Backward-compatibility shim for :mod:`praisonai.cli.commands.diag`.

The implementation moved to :mod:`praisonai_code.cli.commands.diag` as part
...
* ``from praisonai.cli.commands.diag import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.diag.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import diag as _impl
