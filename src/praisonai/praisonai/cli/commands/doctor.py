"""Backward-compatibility shim for :mod:`praisonai.cli.commands.doctor`.

The implementation moved to :mod:`praisonai_code.cli.commands.doctor` as part
...
* ``from praisonai.cli.commands.doctor import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.doctor.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import doctor as _impl
