"""Backward-compatibility shim for :mod:`praisonai.cli.commands.models`.

The implementation moved to :mod:`praisonai_code.cli.commands.models` as part
...
* ``from praisonai.cli.commands.models import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.models.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import models as _impl
