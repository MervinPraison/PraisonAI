"""Backward-compatibility shim for :mod:`praisonai.cli.commands.mcp`.

The implementation moved to :mod:`praisonai_code.cli.commands.mcp` as part
...
* ``from praisonai.cli.commands.mcp import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.mcp.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import mcp as _impl
