"""Backward-compatibility shim for :mod:`praisonai.cli.commands.lsp`.

The implementation moved to :mod:`praisonai_code.cli.commands.lsp` as part
...
* ``from praisonai.cli.commands.lsp import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.lsp.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import lsp as _impl
