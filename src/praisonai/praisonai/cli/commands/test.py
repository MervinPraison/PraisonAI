"""Backward-compatibility shim for :mod:`praisonai.cli.commands.test`.

The implementation moved to :mod:`praisonai_code.cli.commands.test` as part
...
* ``from praisonai.cli.commands.test import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.test.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import test as _impl
