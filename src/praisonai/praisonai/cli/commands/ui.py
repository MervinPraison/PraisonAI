"""Backward-compatibility shim for :mod:`praisonai.cli.commands.ui`.

The implementation moved to :mod:`praisonai_code.cli.commands.ui` as part
...
* ``from praisonai.cli.commands.ui import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.ui.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import ui as _impl
