"""Backward-compatibility shim for :mod:`praisonai.cli.commands.port`.

The implementation moved to :mod:`praisonai_code.cli.commands.port` as part
...
* ``from praisonai.cli.commands.port import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.port.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import port as _impl
