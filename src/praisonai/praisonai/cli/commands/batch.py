"""Backward-compatibility shim for :mod:`praisonai.cli.commands.batch`.

The implementation moved to :mod:`praisonai_code.cli.commands.batch` as part
...
* ``from praisonai.cli.commands.batch import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.batch.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import batch as _impl
