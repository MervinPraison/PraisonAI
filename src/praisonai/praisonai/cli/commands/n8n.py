"""Backward-compatibility shim for :mod:`praisonai.cli.commands.n8n`.

The implementation moved to :mod:`praisonai_code.cli.commands.n8n` as part
...
* ``from praisonai.cli.commands.n8n import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.n8n.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import n8n as _impl
