"""Backward-compatibility shim for :mod:`praisonai.cli.commands.paths`.

The implementation moved to :mod:`praisonai_code.cli.commands.paths` as part
...
* ``from praisonai.cli.commands.paths import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.paths.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import paths as _impl
