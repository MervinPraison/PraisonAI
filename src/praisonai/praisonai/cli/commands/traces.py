"""Backward-compatibility shim for :mod:`praisonai.cli.commands.traces`.

The implementation moved to :mod:`praisonai_code.cli.commands.traces` as part
...
* ``from praisonai.cli.commands.traces import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.traces.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import traces as _impl
