"""Backward-compatibility shim for :mod:`praisonai.cli.commands.app`.

The implementation moved to :mod:`praisonai_code.cli.commands.app` as part
...
* ``from praisonai.cli.commands.app import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.app.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import app as _impl
