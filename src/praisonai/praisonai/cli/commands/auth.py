"""Backward-compatibility shim for :mod:`praisonai.cli.commands.auth`.

The implementation moved to :mod:`praisonai_code.cli.commands.auth` as part
...
* ``from praisonai.cli.commands.auth import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.auth.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import auth as _impl
