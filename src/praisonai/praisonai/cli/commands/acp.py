"""Backward-compatibility shim for :mod:`praisonai.cli.commands.acp`.

The implementation moved to :mod:`praisonai_code.cli.commands.acp` as part
...
* ``from praisonai.cli.commands.acp import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.acp.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import acp as _impl
