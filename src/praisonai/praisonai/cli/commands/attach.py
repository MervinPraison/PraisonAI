"""Backward-compatibility shim for :mod:`praisonai.cli.commands.attach`.

The implementation moved to :mod:`praisonai_code.cli.commands.attach` as part
...
* ``from praisonai.cli.commands.attach import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.attach.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import attach as _impl
