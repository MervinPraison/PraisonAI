"""Backward-compatibility shim for :mod:`praisonai.cli.commands.init`.

The implementation moved to :mod:`praisonai_code.cli.commands.init` as part
...
* ``from praisonai.cli.commands.init import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.init.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import init as _impl
