"""Backward-compatibility shim for :mod:`praisonai.cli.commands.rag`.

The implementation moved to :mod:`praisonai_code.cli.commands.rag` as part
...
* ``from praisonai.cli.commands.rag import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.rag.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import rag as _impl
