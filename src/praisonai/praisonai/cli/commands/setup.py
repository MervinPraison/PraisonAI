"""Backward-compatibility shim for :mod:`praisonai.cli.commands.setup`.

The implementation moved to :mod:`praisonai_code.cli.commands.setup` as part
...
* ``from praisonai.cli.commands.setup import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.setup.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import setup as _impl
