"""Backward-compatibility shim for :mod:`praisonai.cli.commands.flow`.

The implementation moved to :mod:`praisonai_code.cli.commands.flow` as part
...
* ``from praisonai.cli.commands.flow import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.flow.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import flow as _impl
