"""Backward-compatibility shim for :mod:`praisonai.cli.commands.debug`.

The implementation moved to :mod:`praisonai_code.cli.commands.debug` as part
...
* ``from praisonai.cli.commands.debug import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.debug.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import debug as _impl
