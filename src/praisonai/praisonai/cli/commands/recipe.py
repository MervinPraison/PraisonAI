"""Backward-compatibility shim for :mod:`praisonai.cli.commands.recipe`.

The implementation moved to :mod:`praisonai_code.cli.commands.recipe` as part
...
* ``from praisonai.cli.commands.recipe import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.recipe.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import recipe as _impl
