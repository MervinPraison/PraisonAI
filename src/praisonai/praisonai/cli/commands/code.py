"""Backward-compatibility shim for :mod:`praisonai.cli.commands.code`.

The implementation moved to :mod:`praisonai_code.cli.commands.code` as part
...
* ``from praisonai.cli.commands.code import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.code.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import code as _impl
