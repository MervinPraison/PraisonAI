"""Backward-compatibility shim for :mod:`praisonai.cli.commands.docs`.

The implementation moved to :mod:`praisonai_code.cli.commands.docs` as part
...
* ``from praisonai.cli.commands.docs import X`` keeps working, and
* ``unittest.mock.patch("praisonai.cli.commands.docs.X")`` patches the very
  same module object that the implementation executes against.
"""

import sys as _sys

from praisonai_code.cli.commands import docs as _impl
