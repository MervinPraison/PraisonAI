            ...
            if hasattr(self, 'args'):
                ...
                if getattr(self.args, 'external_agent', None):
                    ...
                    try:
                        ...
                        ext_console.print(f"[bold cyan]🔌 Using external agent via manager: {external_agent_name}[/bold cyan]")
                        try:
                            from praisonaiagents import Agent
                            manager = Agent(
                                name="Manager",
                            ...
                            ext_console.print(f"\n[bold green]Result from manager:[/bold green]")
                            ext_console.print(result)
                            return ""
                        except Exception as e:
                            ext_console.print(f"[red]Error executing manager with {external_agent_name}: {e}[/red]")
                            return None
