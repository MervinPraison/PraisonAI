"""
HTTP Server implementation for PraisonAI (moved from core SDK).

This is the concrete implementation of HTTP server with SSE, queues, and threading.
This was moved from praisonaiagents to maintain the protocol-driven architecture 
where core contains only protocols.
