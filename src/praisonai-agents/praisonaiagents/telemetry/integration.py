...
def instrument_workflow(workflow: 'AgentTeam', telemetry: Optional['MinimalTelemetry'] = None, performance_mode: bool = False):
    """
    Instrument an AgentTeam workflow with performance-optimized telemetry.
    
    Args:
        workflow: The AgentTeam instance to instrument
        telemetry: Optional telemetry instance (uses global if not provided)
        performance_mode: If True, uses minimal overhead tracking
    """
    # Early exit if telemetry is disabled by environment variables
...
def auto_instrument_all(telemetry: Optional['MinimalTelemetry'] = None, performance_mode: bool = False):
    """
    Automatically instrument all new instances of Agent and AgentTeam with optimized telemetry.
    ...
    try:
        ...
        original_workflow_init = AgentTeam.__init__
        ...
        AgentTeam.__init__ = workflow_init_wrapper
