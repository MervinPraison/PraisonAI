...
Your Goal: {self.goal}
    ...
    def clone_for_channel(self) -> "Agent":
        ...
        Uses :func:`copy.deepcopy` (which delegates to :meth:`__deepcopy__`)
        so all attributes are preserved and the clone gets fresh threading
        primitives instead of sharing locks with the original.
        """
        import copy
