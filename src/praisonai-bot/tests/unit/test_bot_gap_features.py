...
class TestBackoffPolicy:
    ...
    def test_telegram_preset(self):
        from praisonai_bot.bots._resilience import TELEGRAM_BACKOFF
...
class TestComputeBackoff:
    def test_first_attempt(self):
        from praisonai_bot.bots._resilience import BackoffPolicy, compute_backoff
...
class TestIsRecoverableError:
    def test_timeout_is_recoverable(self):
        from praisonai_bot.bots._resilience import is_recoverable_error
...
class TestConnectionMonitor:
    ...
    def test_record_error_increments(self):
        from praisonai_bot.bots._resilience import ConnectionMonitor, BackoffPolicy
...
class TestSleepWithAbort:
    ...
    async def test_normal_completion(self):
        from praisonai_bot.bots._resilience import sleep_with_abort
...
class TestDaemonService:
    def test_daemon_import(self):
        from praisonai_bot.daemon import get_daemon_status, install_daemon, uninstall_daemon
    ...
    def test_systemd_unit_generation(self):
        from praisonai_bot.daemon.systemd import _generate_unit
...
class TestOnboardWizard:
    def test_import(self):
        from praisonai_bot.cli.features.onboard import OnboardWizard
        assert OnboardWizard is not None

    def test_generate_bot_yaml(self):
        from praisonai_bot.cli.features.onboard import _generate_bot_yaml
    ...
    def test_platforms_info(self):
        from praisonai_bot.cli.features.onboard import PLATFORMS
