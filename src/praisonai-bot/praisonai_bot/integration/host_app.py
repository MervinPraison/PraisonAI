...
def configure_host(
    ...
    **kwargs: Any,
    ...
    datastore_mod = import_wrapper_module("praisonai.ui._aiui_datastore")
    aiui.set_datastore(datastore_mod.PraisonAISessionDataStore())
    ...
    try:
        ext_mod = import_wrapper_module("praisonai.ui._external_agents")
        external = ext_mod.aiui_settings_entries()
            ...
            if agents:
                ...
                if not opt_out:
                    try:
                        ...
                        from praisonai_bot.integration.context_files import load_context_files
