...
class InteractiveCore:
    ...
    def _load_project_context(self) -> str:
        ...
        try:
            ...
            load_context_files = import_wrapper_module(
            ...
            context = ""  # Context files helper is an optional wrapper add-on
        except Exception as e:
    ...
    def _build_subtree_hook_registry(self, already_loaded: str):
        ...
        try:
            ...
            _context_files = import_wrapper_module(
                "praisonai.integration.context_files"
            )
            build_subtree_context_hook = _context_files.build_subtree_context_hook
            file_tool_matcher = _context_files.file_tool_matcher
