...
def _main_py(slug: str) -> str:
    return (
        ...
        "def run():\n"
        "    team = build_team()\n"
        '    result = team.start(inputs={"topic": "AI agents"})\n'
        "    print(result)\n\n\n"
...
def _readme(name: str, slug: str, process: str) -> str:
    return (
        ...
        "```\n\n"
        "## Customise\n\n"
        f"- Edit `src/{slug}/config/agents.yaml` to change roles, goals and backstories.\n"
        f"- Edit `src/{slug}/config/tasks.yaml` to change task descriptions and flow.\n\n"
        "## Run\n\n"
        "```bash\n"
