...
# New toggle variable to force SQLite usage.
# Set this to `True` if you want to skip Supabase/Postgres detection.
# a centralized file or usage of this at a config level would be ideal.
...
class DatabaseManager(SQLAlchemyDataLayer):
    def __init__(self):
        # If the toggle is True, we skip trying to detect or use any DB URL:
        if FORCE_SQLITE:
            self.database_url = None
            logger.info("FORCE_SQLITE flag is set! We will skip Supabase/Postgres detection.")
