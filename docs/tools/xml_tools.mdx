---
title: "XML Tools"
description: "XML file processing tools for AI agents."
icon: "code"
---
...
Use XML Tools to process and manipulate XML files with AI agents.
...
<Steps>
  ...
  <Step title="Import Components">
    ...
    from praisonaiagents.tools import xml
    ```
  </Step>
