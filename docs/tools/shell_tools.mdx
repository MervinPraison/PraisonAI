---
title: "Shell Tools"
description: "Tools for executing shell commands and managing system processes in AI agents."
---
...
<Steps>
  ...
  <Step title="Import Components">
    ...
    from praisonaiagents.tools import shell, execute_command, list_processes, kill_process, get_system_info
    ```
  </Step>
