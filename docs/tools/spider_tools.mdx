---
title: "Spider Tools"
description: "Web scraping and crawling tools for AI agents."
icon: "spider"
---
...
Use Spider Tools to scrape and crawl web content with AI agents.

<Steps>
  <Step title="Install Dependencies">
    First, install the required packages:
    ```bash
    pip install praisonaiagents beautifulsoup4 requests
    ```
  </Step>
  ...
  <Step title="Import Components">
    ...
    from praisonaiagents.tools import scrape_page, extract_content, crawl_links, parse_html, structure_data
    ```
  </Step>
...
spider_agent = Agent(
    name="WebCrawler",
    role="Web Scraping Specialist",
    goal="Extract web content efficiently and ethically.",
    backstory="Expert in web crawling and data extraction.",
    tools=[scrape_page, extract_content, crawl_links, parse_html, structure_data],
    self_reflect=False
)
...
scraping_task = Task(
    ...
    expected_output="Structured article data with text and metadata.",
    agent=spider_agent,
    name="news_scraping"
)
