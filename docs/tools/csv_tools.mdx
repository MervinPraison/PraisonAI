---
title: "CSV Tools"
description: "Tools for working with CSV files in AI agents."
icon: "file-csv"
---
...
<Steps>
  ...
  <Step title="Import Components">
    ...
    from praisonaiagents.tools import csv, read_csv, write_csv, merge_csv
    ```
  </Step>
  ...
  <Step title="Create Agent">
    ...
    csv_agent = Agent(
        ...
        tools=[csv, read_csv, write_csv, merge_csv],
        self_reflect=False
    )
    ```
  </Step>
...
<CardGroup cols={2}>
  <Card title="CSV Agent" icon="user-robot">
    ...
    ```python
    Agent(tools=[csv, read_csv, write_csv, merge_csv])
    ```
  </Card>
